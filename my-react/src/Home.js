    ...
    return (
      <div className="display" >
        <div className="header" style={{position:"relative"}}>
          <div style={{marginLeft:"6rem"}}><h1>BUAKHAO  SHOP</h1></div> 
         </div>
        ...
        <Link to={"/product/add"} className="btn btn-outline-primary me-3" style={{ margin: "1rem" }}>เพิ่ม</Link>

        <div className="container mt-3" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)" }}>
