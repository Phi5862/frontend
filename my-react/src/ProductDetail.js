                        ...
                        <Form noValidate validated={validated} onSubmit={onSave}>
                            ...
                            <Row className="mb-3">
                                <Form.Group as={Col} controlId="validateProductName">
                                    <Form.Label style={{ fontStyle: "italic" }}>ชื่อสินค้า</Form.Label>
                                    <Form.Control
                                        required
                                        type="text"
                                        value={productName}
                            ...
                            <Row className="mb-3">
                                <Form.Group as={Col} controlId="validateProductType">
                                    <Form.Label style={{ fontStyle: "italic" }}>ประเภทสินค้า</Form.Label>
                                    <Form.Select
                                        value={productTypeId}
                            ...
                            <Row className="mb-3">
                                <Form.Group as={Col} controlId="validateProductName">
                                    <Form.Label style={{ fontStyle: "italic" }}>ราคาสินค้า</Form.Label>
                                    <Form.Control
                                        required
                                        type="number"
                                        value={price}
                            ...
                            <Row className="mb-3">
                                <Form.Group as={Col} controlId="validateProductName">
                                    <Form.Label style={{ fontStyle: "italic" }}>จำนวนสินค้า</Form.Label>
                                    <Form.Control
                                        required
                                        type="number"
                                        value={stock}
